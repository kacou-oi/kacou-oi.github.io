...
// Helper function to count connected services from environment variables
// Uses the EXACT same logic as loadConnectedServices
function countConnectedServicesFromEnvVars(envVarNames) {
    // This must match the servicesMap structure exactly - extracted from loadConnectedServices
    const servicesConfig = [
        ...
        { required: ['DYNAMICPDF_API_KEY'] },
        { required: ['APPSCRIPT_URL'] },
        { required: ['APPSCRIPT_GMAIL_URL'] },
        { required: ['APPSCRIPT_DRIVE_URL'] },
        { required: ['APPSCRIPT_DOCS_URL'] },
        { required: ['APPSCRIPT_SHEETS_URL'] },
        { required: ['APPSCRIPT_CALENDAR_URL'] },
        { required: ['APPSCRIPT_MEET_URL'] },
        { required: ['APPSCRIPT_FORMS_URL'] },
        { required: ['EMAIL_API_KEY', 'EMAIL_SERVICE_URL'] },
        { required: ['MISTRAL_AI_API_KEY'] },
        ...
        { required: ['GOOGLE_ANALYTICS_VIEW_ID'] }, // Fixed: was GOOGLE_ANALYTICS_API_KEY
    ...
    servicesConfig.forEach(serviceConfig => {
        // Exact same logic as loadConnectedServices: check if ALL required vars are present
...
// Async helper to calculate connected services count (calls loadConnectedServices logic)
async function calculateConnectedServicesCount(envVarNames) {
    // Reuse the same logic by calling a helper that builds the servicesMap
    // For now, just use the synchronous function
    return countConnectedServicesFromEnvVars(envVarNames);
}
...
async function loadData() {
    try {
        ...
        const loadAgents = fetch(buildApiUrl('/api/agents'), {
            headers: {
                'X-Auth-Key': getAuthToken()
            }
        }).then(res => res.ok ? res.json() : []).catch(e => { console.error("Agents fetch error:", e); return []; });

        const [posts, videos, podcasts, events, agents] = await Promise.all([loadPosts, loadVideos, loadPodcasts, loadEvents, loadAgents]);
        ...
        // Count active AI agents (from /api/agents)
        const statAgentsEl = document.getElementById('stat-agents-count');
        if (statAgentsEl) {
            // Count agents from the agents list (same as shown in the agents view)
            const agentsCount = Array.isArray(agents) ? agents.length : 0;
            statAgentsEl.textContent = agentsCount;
        }
...
async function loadConfig() {
    try {
        ...
        if (analyticsContainer && analyticsGuide && analyticsFrame) {
            console.log('Analytics config:', config.analyticsEmbedUrl); // Debug
            if (config.analyticsEmbedUrl && config.analyticsEmbedUrl.trim() !== '') {
                // Show Analytics
...
window.loadConnectedServices = async function loadConnectedServices() {
    ...
    try {
        ...
        // Helper pour convertir les URLs CDN en chemins locaux
        function getLocalIcon(url) {
            if (!url) return url;
            const urlToFile = {
                'https://cdn.worldvectorlogo.com/logos/github-icon-2.svg': '/static/icons/github-icon-2.svg',
                'https://cdn.worldvectorlogo.com/logos/gemini-icon-logo.svg': '/static/icons/gemini-icon-logo.svg',
                'https://cdn.worldvectorlogo.com/logos/youtube-icon-8.svg': '/static/icons/youtube-icon-8.svg',
                'https://cdn.simpleicons.org/googleappsscript': '/static/icons/googleappsscript.svg',
                'https://cdn.worldvectorlogo.com/logos/official-gmail-icon-2020-.svg': '/static/icons/official-gmail-icon-2020-.svg',
                'https://cdn.worldvectorlogo.com/logos/google-drive-icon-2020.svg': '/static/icons/google-drive-icon-2020.svg',
                'https://cdn.worldvectorlogo.com/logos/google-docs-icon-2.svg': '/static/icons/google-docs-icon-2.svg',
                'https://cdn.worldvectorlogo.com/logos/google-sheets-logo-icon.svg': '/static/icons/google-sheets-logo-icon.svg',
                'https://cdn.worldvectorlogo.com/logos/google-calendar-icon-2020-.svg': '/static/icons/google-calendar-icon-2020-.svg',
                'https://cdn.worldvectorlogo.com/logos/google-meet-icon-2020-.svg': '/static/icons/google-meet-icon-2020-.svg',
                'https://cdn.worldvectorlogo.com/logos/google-forms.svg': '/static/icons/google-forms.svg',
                'https://cdn.worldvectorlogo.com/logos/microsoft-copilot-1.svg': '/static/icons/microsoft-copilot-1.svg',
                'https://cdn.worldvectorlogo.com/logos/deepseek-2.svg': '/static/icons/deepseek-2.svg',
                'https://cdn.worldvectorlogo.com/logos/deepl-1.svg': '/static/icons/deepl-1.svg',
                'https://cdn.worldvectorlogo.com/logos/chatgpt-1.svg': '/static/icons/chatgpt-1.svg',
                'https://cdn.worldvectorlogo.com/logos/wordpress-icon-1.svg': '/static/icons/wordpress-icon-1.svg',
                'https://cdn.worldvectorlogo.com/logos/spotify-2.svg': '/static/icons/spotify-2.svg',
                'https://static.wikia.nocookie.net/logopedia/images/c/ca/StreamYard_2021_%28Icon%29.svg': '/static/icons/streamyard.svg',
                'https://cdn.worldvectorlogo.com/logos/facebook-2020-1-1.svg': '/static/icons/facebook-2020-1-1.svg',
                'https://cdn.worldvectorlogo.com/logos/twitter-6.svg': '/static/icons/twitter-6.svg',
                'https://cdn.worldvectorlogo.com/logos/instagram-2016-5.svg': '/static/icons/instagram-2016-5.svg',
                'https://cdn.worldvectorlogo.com/logos/linkedin-icon-3.svg': '/static/icons/linkedin-icon-3.svg',
                'https://cdn.worldvectorlogo.com/logos/tiktok-icon-2.svg': '/static/icons/tiktok-icon-2.svg',
                'https://cdn.worldvectorlogo.com/logos/meta-3.svg': '/static/icons/meta-3.svg',
                'https://cdn.worldvectorlogo.com/logos/stripe-4.svg': '/static/icons/stripe-4.svg',
                'https://cdn.worldvectorlogo.com/logos/paypal-4.svg': '/static/icons/paypal-4.svg',
                'https://cdn.worldvectorlogo.com/logos/shopify.svg': '/static/icons/shopify.svg',
                'https://cdn.worldvectorlogo.com/logos/google-ads-2.svg': '/static/icons/google-ads-2.svg',
                'https://www.vectorlogo.zone/logos/supabase/supabase-icon.svg': '/static/icons/supabase-icon.svg',
                'https://cdn.worldvectorlogo.com/logos/gitlab.svg': '/static/icons/gitlab.svg',
                'https://cdn.worldvectorlogo.com/logos/google-analytics-4.svg': '/static/icons/google-analytics-4.svg',
                'https://companieslogo.com/img/orig/airtable-5e5cc25f.svg': '/static/icons/airtable.svg',
                'https://cdn.worldvectorlogo.com/logos/trello.svg': '/static/icons/trello.svg',
                'https://cdn.worldvectorlogo.com/logos/canva-wordmark-2.svg': '/static/icons/canva-wordmark-2.svg',
                'https://cdn.worldvectorlogo.com/logos/slack-new-logo.svg': '/static/icons/slack-new-logo.svg',
                'https://cdn.worldvectorlogo.com/logos/twilio.svg': '/static/icons/twilio.svg',
                'https://cdn.worldvectorlogo.com/logos/whatsapp-8.svg': '/static/icons/whatsapp-8.svg',
                'https://cdn.worldvectorlogo.com/logos/zoom-app.svg': '/static/icons/zoom-app.svg'
            };
            return urlToFile[url] || url; // Fallback sur l'URL originale si non trouvé
        }
        ...
        const servicesMap = {
            'GitHub': {
                icon: 'fab fa-github',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/github-icon-2.svg'),
                color: 'bg-slate-900',
            ...
            'Google AI (Gemini)': {
                icon: 'fab fa-google',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/gemini-icon-logo.svg'),
            ...
            'YouTube': {
                icon: 'fab fa-youtube',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/youtube-icon-8.svg'),
                color: 'bg-red-600',
            ...
            'DynamicPDF': {
                ...
                color: 'bg-red-600',
                description: 'API DynamicPDF pour la génération de PDF',
                configUrl: 'https://dpdf.io/',
                required: ['DYNAMICPDF_API_KEY']
            },
            'Google Apps Script': {
                icon: 'fab fa-google',
                iconSvg: getLocalIcon('https://cdn.simpleicons.org/googleappsscript'),
                color: 'bg-yellow-600',
                description: 'Traitement automatique des emails et intégrations via Google Apps Script',
                configUrl: 'https://script.google.com/',
                required: ['APPSCRIPT_URL']
            },
            // Services Google via Apps Script (variables spécifiques uniquement)
            'Gmail': {
                icon: 'fab fa-google',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/official-gmail-icon-2020-.svg'),
                color: 'bg-red-600',
            ...
            'Google Drive': {
                ...
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/google-drive-icon-2020.svg'),
                color: 'bg-blue-400',
            ...
            'Google Docs': {
                ...
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/google-docs-icon-2.svg'),
                color: 'bg-blue-600',
            ...
            'Google Sheets': {
                icon: 'fas fa-table',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/google-sheets-logo-icon.svg'),
                color: 'bg-green-500',
            ...
            'Google Calendar': {
                ...
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/google-calendar-icon-2020-.svg'),
                color: 'bg-blue-500',
            ...
            'Google Meet': {
                icon: 'fas fa-video',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/google-meet-icon-2020-.svg'),
                color: 'bg-green-600',
            ...
            'Google Forms': {
                icon: 'fas fa-poll',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/google-forms.svg'),
                color: 'bg-purple-500',
            ...
            'Mistral AI': {
                icon: 'fas fa-brain',
                iconSvg: '/static/icons/mistral-ai.svg',
                color: 'bg-purple-600',
                description: 'Modèle de langage Mistral AI',
                configUrl: 'https://console.mistral.ai/',
                required: ['MISTRAL_AI_API_KEY']
            },
            'DeepSeek': {
                icon: 'fas fa-brain',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/deepseek-2.svg'),
                color: 'bg-indigo-600',
            ...
            'DeepL': {
                ...
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/deepl-1.svg'),
                color: 'bg-orange-600',
                description: 'Service de traduction DeepL',
                configUrl: 'https://www.deepl.com/pro-api',
                required: ['DEEPL_API_KEY']
            },
            'ChatGPT': {
                icon: 'fas fa-robot',
                iconSvg: '/static/icons/openai.svg',
                color: 'bg-green-600',
                description: 'Modèle de langage ChatGPT (OpenAI)',
            ...
            'WordPress': {
                ...
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/wordpress-icon-1.svg'),
                color: 'bg-blue-600',
            ...
            'Spotify': {
                icon: 'fab fa-spotify',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/spotify-2.svg'),
                color: 'bg-green-500',
            ...
            'StreamYard': {
                icon: 'fas fa-video',
                iconSvg: getLocalIcon('https://static.wikia.nocookie.net/logopedia/images/c/ca/StreamYard_2021_%28Icon%29.svg'),
                color: 'bg-purple-600',
            ...
            'Facebook': {
                ...
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/facebook-2020-1-1.svg'),
                color: 'bg-blue-700',
            ...
            'Twitter/X': {
                icon: 'fab fa-twitter',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/twitter-6.svg'),
                color: 'bg-black',
            ...
            'Instagram': {
                ...
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/instagram-2016-5.svg'),
            ...
            'LinkedIn': {
                ...
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/linkedin-icon-3.svg'),
                color: 'bg-blue-700',
            ...
            'TikTok': {
                icon: 'fab fa-tiktok',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/tiktok-icon-2.svg'),
                color: 'bg-black',
            ...
            'Meta Ads': {
                icon: 'fab fa-meta',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/meta-3.svg'),
                color: 'bg-blue-600',
            ...
            'Stripe': {
                icon: 'fab fa-stripe',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/stripe-4.svg'),
                color: 'bg-indigo-600',
            ...
            'PayPal': {
                icon: 'fab fa-paypal',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/paypal-4.svg'),
                color: 'bg-blue-600',
            ...
            'Shopify': {
                icon: 'fab fa-shopify',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/shopify.svg'),
                color: 'bg-green-600',
            ...
            'Google Ads': {
                icon: 'fab fa-google',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/google-ads-2.svg'),
                color: 'bg-blue-500',
            ...
            'Supabase': {
                ...
                iconSvg: getLocalIcon('https://www.vectorlogo.zone/logos/supabase/supabase-icon.svg'),
                color: 'bg-green-600',
            ...
            'GitLab': {
                icon: 'fab fa-gitlab',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/gitlab.svg'),
                color: 'bg-orange-600',
            ...
            'Google Analytics': {
                icon: 'fab fa-google',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/google-analytics-4.svg'),
                color: 'bg-orange-500',
            ...
            'Airtable': {
                icon: 'fas fa-table',
                iconSvg: getLocalIcon('https://companieslogo.com/img/orig/airtable-5e5cc25f.svg'),
                color: 'bg-orange-500',
            ...
            'Trello': {
                icon: 'fab fa-trello',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/trello.svg'),
                color: 'bg-blue-600',
            ...
            'Canva': {
                icon: 'fab fa-canva',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/canva-wordmark-2.svg'),
                color: 'bg-blue-600',
            ...
            'Slack': {
                icon: 'fab fa-slack',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/slack-new-logo.svg'),
                color: 'bg-purple-600',
            ...
            'Twilio': {
                icon: 'fas fa-sms',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/twilio.svg'),
                color: 'bg-red-600',
                description: 'Service de messagerie SMS via Twilio',
                configUrl: 'https://console.twilio.com',
                required: ['TWILIO_ACCOUNT_SID', 'TWILIO_AUTH_TOKEN', 'TWILIO_PHONE_NUMBER']
            },
            'WhatsApp Business': {
                icon: 'fab fa-whatsapp',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/whatsapp-8.svg'),
                color: 'bg-green-500',
                description: 'API WhatsApp Business pour l\'envoi de messages',
                configUrl: 'https://business.facebook.com/',
                required: ['WHATSAPP_BUSINESS_ACCOUNT_ID', 'WHATSAPP_ACCESS_TOKEN', 'WHATSAPP_PHONE_NUMBER_ID']
            },
            'Zoom': {
                icon: 'fas fa-video',
                iconSvg: getLocalIcon('https://cdn.worldvectorlogo.com/logos/zoom-app.svg'),
                color: 'bg-blue-500',
                description: 'API Zoom pour créer et gérer des réunions vidéo',
                configUrl: 'https://marketplace.zoom.us/develop/create',
                required: ['ZOOM_API_KEY', 'ZOOM_API_SECRET']
            }
        };
